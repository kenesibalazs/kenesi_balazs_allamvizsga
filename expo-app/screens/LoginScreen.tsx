    ...
    useEffect(() => {
        const keyboardDidShowListener = Keyboard.addListener('keyboardDidShow', () => {
            ...
            Animated.timing(animatedValue, {
                toValue: -150, // Change this value for smoother animations
                duration: 300, // Adjust the duration for your preference
    ...
    return (
        <View style={styles.container}>
            ...
            >
                ...
                <Button
                    mode="outlined"
                    onPress={() => console.log('Register with Neptun TODOO')}
